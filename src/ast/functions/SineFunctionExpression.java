...
//Expression for a sine function
public class SineFunctionExpression extends Expression 
{
	...
	public SineFunctionExpression(Expression aExpression)
	{
	...
	{
		return new BigDecimal(Math.sin(fExpression.evaluate().doubleValue()));
	}
}
